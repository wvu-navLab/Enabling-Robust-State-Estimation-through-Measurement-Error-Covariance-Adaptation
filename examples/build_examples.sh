...
g++ test_gnss_switch.cpp -std=c++11 -lboost_system -lboost_program_options -ltbb -I/localhome/ryan_watson/include  -L/localhome/ryan_watson/lib -lgpstk -Wno-deprecated-declarations -lgtsam -I/localhome/ryan_watson/git/ion_gnss_2018/3rdparty/RobustGNSS/gtsam/gtsam/3rdparty/Eigen -o build/test_gnss_switch
